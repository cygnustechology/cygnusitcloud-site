    ...
    <div className="container mx-auto px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-sm font-semibold text-cygnus-red uppercase tracking-wider">About Us</span>
        ...
        >
          <div className="text-center">
            <div className="w-14 h-14 rounded-full bg-cygnus-light flex items-center justify-center mx-auto mb-4">
              <Building2 className="w-7 h-7 text-cygnus-red" />
            </div>
            <h3 className="font-heading text-foreground mb-2">Malaysian Owned</h3>
          ...
          <div className="text-center">
            <div className="w-14 h-14 rounded-full bg-cygnus-light flex items-center justify-center mx-auto mb-4">
              <Users className="w-7 h-7 text-cygnus-red" />
            </div>
            <h3 className="font-heading text-foreground mb-2">Expert Team</h3>
            <p className="text-sm text-muted-foreground text-justify-all">
          ...
          <div className="text-center">
            <div className="w-14 h-14 rounded-full bg-cygnus-light flex items-center justify-center mx-auto mb-4">
              <Target className="w-7 h-7 text-cygnus-red" />
            </div>
            <h3 className="font-heading text-foreground mb-2">Mission-Driven</h3>
            <p className="text-sm text-muted-foreground text-justify-all">
